    ...
    return (
        <div className="h-full flex flex-col animate-fade-in bg-[#0a0a0a]">
            <div className="px-8 py-6 border-b border-white/[0.04] flex-shrink-0 bg-neutral-900/20">
                ...
                <p className="text-neutral-500 text-sm mt-1 ml-[40px]">
            ...
            <div className="flex flex-1 overflow-hidden">
                <div className="w-64 border-r border-white/[0.04] p-4 flex flex-col gap-1 overflow-y-auto bg-neutral-900/10">
                    <div className="text-xs font-semibold text-neutral-600 uppercase tracking-wider mb-2 px-3">
                        Preferences
                    </div>
                    {tabs.map((tab) => (
                        <button
    ...
    return (
        <div className="space-y-8 animate-slide-up">
            ...
            <div className="space-y-4">
                <h2 className="text-lg font-medium text-white border-b border-white/[0.04] pb-2">
                    Personal Details
                </h2>
...
function AppearanceSettings() {
    ...
    return (
        <div className="space-y-8 animate-slide-up">
            ...
            <div>
                <h2 className="text-lg font-medium text-white mb-4 border-b border-white/[0.04] pb-2">
                    Layout Density
                </h2>
...
function SecuritySettings() {
    return (
        <div className="space-y-8 animate-slide-up">
            ...
            <div>
                <h2 className="text-lg font-medium text-red-400 mb-4 border-b border-red-500/10 pb-2">
                    Danger Zone
                </h2>
