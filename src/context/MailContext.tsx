...
export function MailProvider({ children }: { children: ReactNode }) {
  ...
  const fetchEmails = useCallback(async () => {
    try {
      ...
      const data: ApiEmailItem[] = await response.json();
      const fetchedEmails: EmailItem[] = data.map((email: ApiEmailItem) => {
        ...
        return {
          ...
          isRead: false, // Default to unread, as API doesn't provide this
          isStarred: false, // Default to unstarred, as API doesn't provide this
          folder: 'inbox', // Default to inbox, as API doesn't provide this
          labels: [], // Default to empty, as API doesn't provide this
